...
{
    public class EmpLoginAccessCoreService : IEmpLoginAccessCoreService
    {
        private readonly IMediator _mediator;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IMapper _mapper;

        public EmpLoginAccessCoreService(IMediator mediator, IHttpContextAccessor httpContextAccessor,
            IMapper mapper)
        {
        ...
        public async Task<EmpLoginAccessBaseResponseDto> Execute(EmpLoginAccessRequestDto request, CancellationToken ct)
        {
            try
            {
                var requestCmd = _mapper.Map<EmpLoginAccessRequestDto, EmpLoginAccessCommand>(request);
