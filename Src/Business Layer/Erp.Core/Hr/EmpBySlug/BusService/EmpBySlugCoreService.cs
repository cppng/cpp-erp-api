...
{
    public class EmpBySlugCoreService : IEmpBySlugCoreService
    {
        private readonly IMediator _mediator;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IMapper _mapper;

        public EmpBySlugCoreService(IMediator mediator, IHttpContextAccessor httpContextAccessor,
            IMapper mapper)
        {
        ...
        public async Task<EmployeeDetailsBaseResponseDto> Execute(string slug, CancellationToken ct)
        {
            try
            {
                return await _mediator.FetchAsync(new EmpBySlugQueryRequest
                {
                    Slug = slug,
                    Username = ""
                }, ct);
