...
{
    public class EmpBasicUpdateCoreService : IEmpBasicUpdateCoreService
    {
        private readonly IMediator _mediator;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IMapper _mapper;

        public EmpBasicUpdateCoreService(IMediator mediator, IHttpContextAccessor httpContextAccessor,
            IMapper mapper)
        {
        ...
        public async Task<EmpBasicUpdateBaseResponseDto> Execute(EmpBasicUpdateRequestDto request, CancellationToken ct)
        {
            try
            {
                var requestCmd = _mapper.Map<EmpBasicUpdateRequestDto, EmpBasicUpdateCommand>(request);
