...
{
    public class EmpSalaryUpdateCoreService : IEmpSalaryUpdateCoreService
    {
        private readonly IMediator _mediator;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IMapper _mapper;

        public EmpSalaryUpdateCoreService(IMediator mediator, IHttpContextAccessor httpContextAccessor,
            IMapper mapper)
        {
        ...
        public async Task<EmpSalaryUpdateBaseResponseDto> Execute(EmpSalaryUpdateRequestDto request, CancellationToken ct)
        {
            try
            {
                var requestCmd = _mapper.Map<EmpSalaryUpdateRequestDto, EmpSalaryUpdateCommand>(request);
