...
namespace Erp.Core.User.EmpDetailsUpdate.BusService
{
    public class EmpDetailsUpdateCoreService : IEmpDetailsUpdateCoreService
    {
        private readonly IMediator _mediator;
        private readonly IHttpContextAccessor _httpContextAccessor;
        private readonly IMapper _mapper;

        public EmpDetailsUpdateCoreService(IMediator mediator, IHttpContextAccessor httpContextAccessor,
            IMapper mapper)
        {
        ...
        public async Task<EmpDetailsUpdateBaseResponseDto> Execute(EmpDetailsUpdateRequestDto request, CancellationToken ct)
        {
            try
            {
                var requestCmd = _mapper.Map<EmpDetailsUpdateRequestDto, EmpDetailsUpdateCommand>(request);
